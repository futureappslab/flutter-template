...
> **IMPORTANTE (Gemini):** las reglas canónicas de este proyecto viven en `AGENTS.md`.
> Este archivo existe solo porque Gemini carga `GEMINI.md` automáticamente; su única función es
> redirigir a la fuente única y evitar reglas duplicadas. **No añadas reglas aquí.**
